...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Demo mode - allow any email/password to login (like Figma)
    if (email && password) {
      setError('');
      setLoading(true);
  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        inset: 0,
        pointerEvents: 'none',
        background: 'radial-gradient(circle 800px at 50% 20%, rgba(102,126,234,0.25), transparent), radial-gradient(circle 600px at 80% 60%, rgba(118,75,162,0.2), transparent)',
      }} />
      ...
      <Box sx={{
        ...
        <iframe
          title="spline-bg"
          src="https://my.spline.design/abstractshape-0d7b0c7b8ce4-embedded"
